		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
						<h1>1-Cargar Evolucion de los pacientes:</h1>
						
						
								<form action="subirEvolucion.php"  action="uploader.php" method="POST">
								</br>
<input type="date" name="fecha" step="1" min="<?php echo $min; ?>" max="<?php echo $max; ?>" value="<?php echo $hoy; ?>"
							 ...
							 <textarea name="evolucion" rows="10" cols="40" id="evolucion" placeholder="Cargar Evolucion" required></textarea>
						</br></br> <p>Seleccionar el paciente al que pertenece la evolucion     </p>
                                <div id="fade-box">
								...
								<button>Guardar</button>
									...
									<h1>2-Ver Evolucion de un paciente:</h1>
						</br>
