...
{
    /**
     * Valida los datos de entrada para la creación de una Historia Clínica.
     * 
     ...
     */
    public static function validar($post, $files = null)
    {
        $errores = [];
        ...
        // 5. Validación de la Edad (Debe ser entero positivo y razonable, ej. 0 a 125)
